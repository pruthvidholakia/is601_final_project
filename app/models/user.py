...
class User(Base):
    ...
    def update_profile(self, db, **data):
        ...
        # Uniqueness checks if username/email are being updated
        conflict_filters = []
        if "username" in payload:
            conflict_filters.append(User.username == payload["username"])
        if "email" in payload:
            conflict_filters.append(User.email == payload["email"])
